  ...
  <body>
    ...
    <div id="titulo">
        ...
        <header class="btn_cadastro">
            <button class="btn btn-primary" data-toggle="modal" data-target="#modal-mensagem">Cadastrar Aluno</button>
        </header>
            ...
            <div class="resultados_cadastro_aluno">
                <table>
                    ...
                    <?php
                        ...
                        $sql = mysqli_query($cx, "SELECT * FROM alunos WHERE visivel<>'1'") or die( 
                    ...
                    <tr>
                        ...
                        <td><a href="editar/editaralunos.php?id=<?php echo $aux["id"];?>" class="btneditar">Editar</a> | <a href="excluir/excluiralunos.php?id=<?php echo $aux["id"];?>" class="btnexcluir">Excluir</a></td>
                    </tr>
                     <?php } ?> 
                </table>
            </div>
