  ...
  <body>
    ...
    <div id="titulo">
        ...
        <header class="btn_cadastro">
            <button class="btn btn-primary" data-toggle="modal" data-target="#modal-mensagem">Cadastrar Professores</button>
        </header>
            ...
            <div class="resultados_cadastro_aluno">
                <table>
                    ...
                    <?php
                        ...
                        $sql = mysqli_query($cx, "SELECT * FROM professores WHERE visivel<>'1'") or die( 
                    ...
                    <tr>
                        ...
                        <td><a href="editar/editarprofessores.php?id=<?php echo $aux["id"];?>" class="btneditar">Editar</a> | <a href="excluir/excluirprofessores.php?id=<?php echo $aux["id"];?>" class="btnexcluir">Excluir</a></td>
                    </tr>
                     <?php } ?> 
                </table>
            </div>
   ...
   <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Dados do Professor</h4>
            </div>
